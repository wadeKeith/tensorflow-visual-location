...
x_image = tf.reshape(x, [-1, 200, 113, 3])
...
w_fc1 = weight_variable([188*101*1, 1024])
b_fc1 = bias_variable([1024])
h_conv3_flat = tf.reshape(h_conv3, [-1, 188*101*1])
...
print(y.eval(feed_dict={x: train, y_: train_label}))

# img5 = h_conv1_t.eval(feed_dict={x: train, y_: train_label})
# t = img5[0]
# print(t.shape)
# plt.imshow(t)
# plt.savefig('abc1')
